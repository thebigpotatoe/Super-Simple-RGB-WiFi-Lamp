...
const char websiteSource[] PROGMEM =
  ...
  "            <h2>Clock Mode</h2>\n"
  "            <p>In this mode the light will display the current time in 12 hr format using the\n"
  "                top and bottom side of the light. On the top is the current hour, and the bottom is the minute. The left\n"
  "                of the light represents 0 and the right represents either 12hr or 60mins. You can choose the colour of\n"
