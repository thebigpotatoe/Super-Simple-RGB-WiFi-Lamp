...
void servePage() {
  ...
  restServer.sendContent_P(PSTR("            }\n"));
  restServer.sendContent_P(PSTR("            if (\"ColorWipe\" in jsonMessage) {\n"));
  restServer.sendContent_P(PSTR("                // console.log(\"Found ColorWipe Message\")\n"));
  restServer.sendContent_P(PSTR("                handlecolorWipeMessage(jsonMessage[\"ColorWipe\"])\n"));
  restServer.sendContent_P(PSTR("            }\n"));
...
//  restServer.sendContent_P(PSTR("                }\n"));
  ...
  restServer.sendContent_P(PSTR("            if (typeof jsonMessage === \"object\") {\n"));
  restServer.sendContent_P(PSTR("                var newRed = colorWipeRed\n"));
  restServer.sendContent_P(PSTR("                var newGreen = colorWipeGreen\n"));
  restServer.sendContent_P(PSTR("                var newBlue = colorWipeBlue\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                if ((\"Red\" in jsonMessage)) {\n"));
  restServer.sendContent_P(PSTR("                    if (typeof jsonMessage.Red === \"number\") {\n"));
  restServer.sendContent_P(PSTR("                        newRed = jsonMessage.Red\n"));
  ...
  restServer.sendContent_P(PSTR("                        <a class=\"nav-link\" data-toggle=\"tab\" href=\"#colorWipe\">ColorWipe</a>\n"));
  restServer.sendContent_P(PSTR("                    </li>\n"));
  ...
  restServer.sendContent_P(PSTR("                        sendMessage({\"Mode\":\"ColorWipe\"})\n"));
  restServer.sendContent_P(PSTR("                    });\n"));
  ...
  restServer.sendContent_P(PSTR("                <label for=\"brightness\">Brightness: <span id=\"brightnessLabel\">100</span></label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"brightness\" type=\"range\" min=\"0\" max=\"255\" step=\"1\" value=\"255\" class=\"form-control-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  ...
  restServer.sendContent_P(PSTR("            <button id=\"colorWipeButton\" type=\"submit\" class=\"col mb-2 mx-2 btn btn-lg btn-outline-light\">ColorWipe</button>\n"));
...
//  restServer.sendContent_P(PSTR("                            \"Brightness\": Math.round(currentBrightnessValue/100*255)\n"));
  ...
  restServer.sendContent_P(PSTR("            <h2>ColorWipe Mode</h2>\n"));
  restServer.sendContent_P(PSTR("            <p>ColorWipe. Explanation needed \n"));
  ...
  restServer.sendContent_P(PSTR("                    renderCallback: function($elm, toggled) {\n"));
  restServer.sendContent_P(PSTR("                        var colors = this.color.colors;\n"));
  restServer.sendContent_P(PSTR("                        onOncolorWipePickerEvent(Math.round(colors.rgb.r*255), Math.round(colors.rgb.g*255), Math.round(colors.rgb.b*255))\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                        this.$colorPatch.css({\n"));
  restServer.sendContent_P(PSTR("                            backgroundColor: '#' + colors.HEX,\n"));
  restServer.sendContent_P(PSTR("                            color: colors.RGBLuminance > 0.22 ? '#222' : '#ddd'\n"));
  ...
  restServer.sendContent_P(PSTR("                })\n"));
  restServer.sendContent_P(PSTR("\n"));
  restServer.sendContent_P(PSTR("                function onOncolorWipePickerEvent(red, green, blue) {\n"));
  restServer.sendContent_P(PSTR("                    if (bellRed != red || bellGreen != green || bellBlue != blue) {\n"));
  restServer.sendContent_P(PSTR("                        msg = {\n"));
  restServer.sendContent_P(PSTR("                            \"State\" : true,\n"));
  restServer.sendContent_P(PSTR("                            \"Mode\" : \"ColorWipe\", \n"));
  restServer.sendContent_P(PSTR("                            \"ColorWipe\": {\n"));
  restServer.sendContent_P(PSTR("                                \"Red\": red,\n"));
  restServer.sendContent_P(PSTR("                                \"Green\": green,\n"));
  restServer.sendContent_P(PSTR("                                \"Blue\": blue\n"));
  restServer.sendContent_P(PSTR("                            }\n"));
