...
void servePage() {
  ...
  restServer.sendContent_P(PSTR("                <input id=\"fadeTime\" type=\"range\" min=\"0\" max=\"2000\" step=\"100\" value=\"200\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  ...
  restServer.sendContent_P(PSTR("                <input id=\"rainbowHue\" type=\"range\" min=\"0\" max=\"359\" step=\"1\" value=\"0\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  ...
  restServer.sendContent_P(PSTR("                <input id=\"rainbowBrightness\" type=\"range\" min=\"0\" max=\"100\" step=\"1\" value=\"100\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  restServer.sendContent_P(PSTR("                <label for=\"rainbowSpeed\">Rainbow Speed: <span id=\"rainbowSpeedLabel\">10</span> seconds</label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"rainbowSpeed\" type=\"range\" min=\"0\" max=\"10\" step=\"1\" value=\"10\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <script>\n"));
  ...
  //restServer.sendContent_P(PSTR("                <input id=\"sparkleSpeed\" type=\"range\" min=\"0\" max=\"10\" step=\"1\" value=\"5\" class=\"form-control-range custom-range\">\n"));
  //restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <script>\n"));
  ...
  //restServer.sendContent_P(PSTR("                <input id=\"confettiSpeed\" type=\"range\" min=\"0\" max=\"10\" step=\"1\" value=\"5\" class=\"form-control-range custom-range\">\n"));
  //restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <script>\n"));
  ...
  restServer.sendContent_P(PSTR("                <input id=\"visualiserPeriod\" type=\"range\" min=\"100\" max=\"2000\" step=\"50\" value=\"250\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  ...
  restServer.sendContent_P(PSTR("                <input id=\"visualiserMinThreshold\" type=\"range\" min=\"0\" max=\"300\" step=\"10\" value=\"100\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  ...
  restServer.sendContent_P(PSTR("                <input id=\"visualiserMaxThreshold\" type=\"range\" min=\"400\" max=\"3000\" step=\"50\" value=\"750\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  restServer.sendContent_P(PSTR("                <label for=\"visualiserFadeUp\"><b>Fade Up Delay</b>: <span id=\"visualiserFadeUpLabel\">32</span></label>\n"));
  restServer.sendContent_P(PSTR("                <input id=\"visualiserFadeUp\" type=\"range\" min=\"0\" max=\"255\" step=\"1\" value=\"32\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  ...
  restServer.sendContent_P(PSTR("                <input id=\"visualiserFadeDown\" type=\"range\" min=\"0\" max=\"255\" step=\"1\" value=\"32\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
  restServer.sendContent_P(PSTR("            <div>\n"));
  ...
  restServer.sendContent_P(PSTR("                <input id=\"visualiserHueOffset\" type=\"range\" min=\"0\" max=\"359\" step=\"1\" value=\"170\" class=\"form-control-range custom-range\">\n"));
  restServer.sendContent_P(PSTR("            </div>\n"));
